...
class LlamaCLIIntegration:
    ...
    def __init__(self):
        models_dir = os.getenv("LLM_MODELS_DIR", "X:/ExternalSoftDAta/llama.cpp/models")
        model_name = os.getenv("LLM_MODEL_FILENAME", "gemma-4-E2B-it-UD-Q3_K_XL.gguf")
        
        self.llama_cli = Path(os.getenv("LLAMA_CLI_PATH", "X:/ExternalSoftDAta/llama.cpp/build/bin/Release/llama-cli.exe"))
        self.model_path = Path(models_dir) / model_name
